...
public class TCP_Client{
    ...
    public static void main(String[] args) throws IOException {
       ...
       // FutureTask<String> userInputTask = new FutureTask<>(new InputReciever(userInputScanner));
        Boolean flag = true;
        ...
        while (flag) {
            ...
            }else{PrintTools.println("The Input Cannot Be Empty!",PrintTools.ANSI_Yellow);}
